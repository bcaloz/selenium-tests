...
def test_valid_form_submission_redirects(driver: WebDriver) -> None:
    ...
    page.fill_form(
        name="Brian QA", phone="345-6789190", date="07-16-2025", payment_method="card"
    )
